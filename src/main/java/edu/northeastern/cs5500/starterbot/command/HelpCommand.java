...
public class HelpCommand implements Command {
    ...
    public CommandData getCommandData() {
        return new CommandData(getName(), "Show some help about the bot's commands").addOptions();
    }
    ...
    public void onEvent(CommandInteraction event) {
        ...
        info.addField(
                "/fightStadium",
                ":fist: Start fighting the stadium if there is a stadium open for fight in the current location.",
                false);
        info.addField(
                "/catchPokemon",
                "Start catching the pokemoon if you meet a wild pokemon in your area.",
                false);
        ...
        info.addField(
                "/moving <DIRECTION>",
                "Using w/a/s/d for DIRECTIONs of North/West/South/East. ",
                false);
        info.setImage(
